// This example uses the Alpha Vantage API (https://www.alphavantage.co/)
...
// Function to update the stock prices in the HTML
async function updateStockPrices() {
  const stockSymbols = ['AAPL', 'MSFT', 'GOOGL']; // Example stock symbols
  ...
  for (let symbol of stockSymbols) {
    ...
    stockPricesElement.innerHTML += `<p>${symbol}: $${price}</p>`;
  }
}

// Update stock prices every 10 seconds
updateStockPrices();
setInterval(updateStockPrices, 10000); // 10 seconds interval
